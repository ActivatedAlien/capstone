...
- [ ] Learn about the game and various setups
- [ ] Create Mafia events
- [ ] Search for events
- [ ] Sign up for events
...
### Phase 1: User Authentication, Event/Post Creation (~1 day)
I will implement user authentication in Rails based on the practices learned at
App Academy. By the end of this phase, users will be able to create events and make
posts on the forum using a simple text form in a Rails view. The most important
...
I will add API routes to serve event and forum data as JSON, then add Backbone
models and collections that fetch data from those routes. By the end of this
phase, users will be able to create and view both events and forum posts, all
...
edits it. I will create a User Show page that will contain a list of the
